...
namespace KuguaSdk.Onebot11
{
    ...
    public class send_private_msg : SenderData
    {
        ...
        public send_private_msg(string user_id, List<Message> message)
        {
    ...
    public class send_group_msg : SenderData
    {
        ...
        public send_group_msg(string group_id, List<Message> message)
        {
    ...
    public class send_msg : SenderData
    {
        ...
        public send_msg(string message_type, string user_id, string group_id, List<Message> message)
        {
