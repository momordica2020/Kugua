namespace LiveServer
{
    partial class FormMonitor
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { 存档当前配置ToolStripMenuItem, 文件ToolStripMenuItem, 测试gptToolStripMenuItem, 启动b站监听ToolStripMenuItem });
