...
//    class RaceHorseHelper 
//    {
//        string userinfoFile = "DataRacehorse/userinfo.txt";
//        string horseinfoFile = "DataRacehorse/horseinfo.txt";
...
//        public RaceHorseHelper()
//        {

//        }
//        public string HandleMessage(long userid, long group, string cmd)
//        {
//            try
//            {
...
//                if (cmd == "富豪榜" || cmd == "富人榜")
//                {
//                    return bank.showRichest();
//                }

//                if (cmd == "穷人榜")
//                {
//                    return bank.getMoneyManager().showPoorest();
//                }

//                if (cmd == "个人信息")
//                {
//                    return $"{bank.getUserInfo(userid)}\r\n{getRHInfo(userid)}";
...
//        protected void InitSource(Config _config, BankHelper _bank)
//        {
//            lock (matchMutex)
//            {
//                try
...
//                    var lines = FileHelper.readLines(config.appConfig.SourcePath + userinfoFile);
...
//                        users[user.id] = user;
//                    }
//                    lines = FileHelper.readLines(config.appConfig.SourcePath + horseinfoFile);
//                    foreach (var line in lines)
//                    {
...
//                    }
//                    FileHelper.writeText(config.appConfig.SourcePath + userinfoFile, sb.ToString());
//                }
//                catch (Exception ex)
//                {
//                    FileHelper.Log(ex);
...
//        {
//            return bank.getUser(user.id).addMoney(num);
//        }
...
//        {
//            return bank.getUser(user.id).Money;
//        }

//        public string getNickName(RHUser user)
//        {
//            return bank.getUser(user.id).UserName;
//        }
...
//        {
//            return RaceHorseHelper.rand.Next(minspeed, maxspeed);
//        }
//    }
...
//                {
//                    roads[i] = new RHRoad(i, _horses[RaceHorseHelper.rand.Next(_horses.Count)]);
...
//            }
//            // skill test
//            if (RaceHorseHelper.rand.Next(100) < 20)
//            {
//                // play a skill!
//                int skillNum = RaceHorseHelper.rand.Next(1, roadnum + 1);
...
//            double pl = RaceHorseHelper.rand.Next(1000, 6666);
//            long othermoneys = 0;
//            long winnermoneys = 0;
