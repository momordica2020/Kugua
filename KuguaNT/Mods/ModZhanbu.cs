    ...
    public class ModZhanbu : Mod
    {
        ...
        public string 解读卦象(MessageContext context, string[] param)
        {
            ...
            switch (变爻.Count)
            {
                ...
                case 2:
                    解卦描述 = $"{取卦名(本卦)}之{取卦名(之卦)}\r\n" +
                        $"变爻有二：{取爻名(变爻[0], 本卦[变爻[0]])}、{取爻名(变爻[1], 本卦[变爻[1]])}\r\n" +
                        $"{取爻辞(本卦, 变爻[0])}\r\n{取爻辞(本卦, 变爻[1])}";
                    break;
                case 3:
                    解卦描述 = $"{取卦名(本卦)}之{取卦名(之卦)}\r\n" +
                        $"变爻有三：{取爻名(变爻[0], 本卦[变爻[0]])}、{取爻名(变爻[1], 本卦[变爻[1]])}、{取爻名(变爻[2], 本卦[变爻[2]])}\r\n" +
                        $"{取卦辞(本卦)}\r\n{取卦辞(之卦)}"; break;
                case 4:
                    解卦描述 = $"{取卦名(本卦)}之{取卦名(之卦)}\r\n" +
                        $"变爻有四：{取爻名(变爻[0], 本卦[变爻[0]])}、{取爻名(变爻[1], 本卦[变爻[1]])}、{取爻名(变爻[2], 本卦[变爻[2]])}、{取爻名(变爻[3], 本卦[变爻[3]])}\r\n" +
                        $"{取爻辞(之卦, 变爻[0])}\r\n{取爻辞(之卦, 变爻[1])}";
                    break;
                case 5:
                    解卦描述 = $"{取卦名(本卦)}之{取卦名(之卦)}\r\n" +
                        $"变爻有五：{取爻名(变爻[0], 本卦[变爻[0]])}、{取爻名(变爻[1], 本卦[变爻[1]])}、{取爻名(变爻[2], 本卦[变爻[2]])}、{取爻名(变爻[3], 本卦[变爻[3]])}、{取爻名(变爻[4], 本卦[变爻[4]])}\r\n" +
                        $"{取爻辞(之卦, 变爻[0])}";
                    break;
                case 6:
                    解卦描述 = $"{取卦名(本卦)}\r\n之{取卦名(之卦)}，六爻皆变\r\n" +
        ...
        public string 取Unicode卦象字符(string 卦名)
        {
            string[] 文王卦序 = {
                "乾", "坤", "屯", "蒙", "需", "讼", "师", "比",
                "小畜", "履", "泰", "否", "同人", "大有", "谦", "豫",
